...
(function(){
  ...
  const BRAND_PACKS={
    coral:{
      ...
      support:'Curated sales-pitch demo: four hero products, dosing intelligence, refill prediction and ICP-aware tracking.',
      groups:['Core Method'],
      products:[
