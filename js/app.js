...
const AQX_FIREBASE_BUILD = "pwa-install-fixed-20260507d";
...
(function(){
  ...
  const ENABLED_KEY='aqxNotificationsEnabledV1';
  const BUILD='pwa-install-fixed-20260507d';
  function $(id){return document.getElementById(id);}
...
(function(){
  ...
  document.addEventListener('DOMContentLoaded', function(){
    ...
    if('serviceWorker' in navigator){
      navigator.serviceWorker.register('./sw.js?v=pwa-install-fixed-20260507d', {scope:'./'}).then(function(reg){
