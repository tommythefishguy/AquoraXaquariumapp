const AQX_CACHE = 'aquorax-pwa-vfix20260507-firestore-fcm-clean-20260507c';
const AQX_ASSETS = ['./','./index.html','./css/styles.css?v=firestore-fcm-clean-20260507c','./js/app.js?v=firestore-fcm-clean-20260507c','./aquorax-logo.png','./manifest.webmanifest','./assets/icon-192.png','./assets/icon-512.png'];
...
self.addEventListener('notificationclick', event => {
  ...
  const target = (event.notification && event.notification.data && event.notification.data.url) || './index.html?v=firestore-fcm-clean-20260507c';
