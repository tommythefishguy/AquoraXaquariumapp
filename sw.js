const AQX_CACHE = 'aquorax-pwa-vfix20260507-fcm-real-time-20260507a';
const AQX_ASSETS = ['./','./index.html','./css/styles.css?v=fcm-real-time-20260507a','./js/app.js?v=fcm-real-time-20260507a','./aquorax-logo.png','./manifest.webmanifest','./assets/icon-192.png','./assets/icon-512.png'];
