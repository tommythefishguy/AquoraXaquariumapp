const AQX_CACHE = 'aquorax-pwa-scope-fixed-20260507e';
const AQX_BASE = '/AquoraXaquariumapp/';
const AQX_ASSETS = [AQX_BASE, AQX_BASE+'index.html', AQX_BASE+'manifest.webmanifest', AQX_BASE+'css/styles.css?v=pwa-scope-fixed-20260507e', AQX_BASE+'js/app.js?v=pwa-scope-fixed-20260507e', AQX_BASE+'aquorax-logo.png', AQX_BASE+'assets/icon-192.png', AQX_BASE+'assets/icon-512.png', AQX_BASE+'assets/icon-maskable-192.png', AQX_BASE+'assets/icon-maskable-512.png'];
...
self.addEventListener('notificationclick', event => {
  ...
  const target = (event.notification && event.notification.data && event.notification.data.url) || './index.html?v=pwa-scope-fixed-20260507e';
