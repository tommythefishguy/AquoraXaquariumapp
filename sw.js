const AQX_CACHE = 'aquorax-coral-essentials-ecosystem-v1';
const AQX_BASE = '/AquoraXaquariumapp/';
const AQX_ASSETS = [AQX_BASE, AQX_BASE+'index.html', AQX_BASE+'manifest.webmanifest', AQX_BASE+'css/styles.css?v=coral-essentials-ecosystem-v1', AQX_BASE+'js/app.js?v=coral-essentials-ecosystem-v1', AQX_BASE+'aquorax-logo.png', AQX_BASE+'assets/icon-192.png', AQX_BASE+'assets/icon-512.png', AQX_BASE+'assets/icon-maskable-192.png', AQX_BASE+'assets/icon-maskable-512.png', AQX_BASE+'assets/coral-essentials-logo.jpg'];
...
self.addEventListener('notificationclick', event => {
  ...
  const target = (event.notification && event.notification.data && event.notification.data.url) || './index.html?v=coral-essentials-ecosystem-v1';
