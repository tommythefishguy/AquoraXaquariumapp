const AQX_CACHE = 'aquorax-pwa-v20260507-firebase-real-fixed-b';
const AQX_ASSETS = ['./','./index.html','./css/styles.css?v=firebase-real-fixed-20260507b','./js/app.js?v=firebase-real-fixed-20260507b','./aquorax-logo.png','./manifest.webmanifest','./assets/icon-192.png','./assets/icon-512.png'];
